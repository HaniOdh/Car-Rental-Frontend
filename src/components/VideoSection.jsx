                ...
                {showVideo && (
                    <div className="fixed inset-0 bg-black bg-opacity-10 z-50 flex items-center justify-center px-4">
                        <div className="relative w-full max-w-3xl">
                            <button className="absolute top-2 right-2 text-white text-2xl hover:text-red-500" 
                            onClick={()=>setShowVideo(false)}><X className="cursor-pointer" /></button>
                            <div className="aspect-w-16 aspect-h-9 h-[400px] w-full">
                                <iframe src="https://www.youtube.com/embed/ogOfLrl_7wU?si=skcwImDOejie5eC0" 
                                title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; 
                                encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin"
                                 allowfullscreen className="rounded-lg w-full h-full"></iframe>
                            </div>
                        </div>
                    </div>
                )}
