        ...
        <div className="py-14 flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700 px-4">
            ...
            <div className="w-full max-w-md bg-gray-100 rounded-lg shadow-lg p-8 pt-5 reveal-x-alt">
                ...
                <form action="">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="First Name" className="w-full bg-white pl-10 pr-4 py-2 border border-gray-300
                            rounded-md outline-none focus:ring-2 focus:ring-blue-500"/>
                        </div>
                        <div className="relative">
                            <User className="absolute left-3 top-3 text-gray-400 w-5 h-5" />
                            <input type="text" placeholder="Last Name" className="w-full bg-white pl-10 pr-4 py-2 border border-gray-300
                            rounded-md outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            ...
                            <input type="email" name="email" className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 
                            rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your email address"/>
                        </div>
                    </div>
                    ...
                    py-2 font-medium transition color-transition duration-300">Sign Up</button>
                </form>
                ...
                <p className="text-center text-sm text-gray-600 mt-6">
                    Already have an account? <a href="/login" className="text-blue-500 hover:underline hover:text-blue-700">Log In</a>
                </p>
            </div>
        </div>
    );
